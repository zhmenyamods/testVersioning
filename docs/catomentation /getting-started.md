...
`/coverage/v2/survevresources/boundaries.{fileFormat}`
...
If you don't have an API, then no worries! ReadMe is great for any sort of documentation. But if you have an API, there are a few features to make your experience with ReadMe (and your users' experience with your developer hub!) a magical one: <a href="https://www.test.com" target="_blank">Test</a>
